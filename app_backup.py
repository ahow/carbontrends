...
if page == "Dashboard":
    ...
    if portfolio_file is not None and 'portfolio_name' in locals() and portfolio_name:
        try:
            with st.spinner("Processing portfolio data..."):
                ...
                if portfolio_data:
                    action = st.session_state.get("portfolio_action", "Create new portfolio")
                    ...
                    elif action == "Add to existing portfolio":
